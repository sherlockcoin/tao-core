...
/* Dark features */
    ...
    { "alphanode",             &alphanode,             true,      false,      true },
    { "alphanodelist",         &alphanodelist,         true,      false,      false },
    ...
    { "getnewencapsulatedaddress",   &getnewencapsulatedaddress,   false,     false,     true },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("%s, you must set a rpcpassword in the configuration file:\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"Tao Alert\" admin@foo.com\n"),
                strWhatAmI,
    ...
    LogPrintf("Binding RPC Port to %u.\n",endpoint.port());
