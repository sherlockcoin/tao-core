...
#ifndef _TAORPC_SERVER_H_
#define _TAORPC_SERVER_H_ 1
...
extern json_spirit::Value getnewencapsulatedaddress(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value alphanode(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value alphanodelist(const json_spirit::Array& params, bool fHelp);
