...
/**
 * Split tao command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if(model)
    {
        ...
        setAlphanodeCount(model->getAlphanodeCountString());
        connect(model, SIGNAL(strAlphanodesChanged(QString)), this, SLOT(setAlphanodeCount(QString)));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Tao RPC console.") + "<br>" +
...
void RPCConsole::setAlphanodeCount(const QString &strAlphanodes)
{
    ui->alphanodeCount->setText(strAlphanodes);
}
